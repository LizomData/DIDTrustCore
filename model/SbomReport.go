...
type SBOMReport struct {
	DidID        string `gorm:"type:varchar(255);not null;" json:"-"`
	SbomFilename string `gorm:"type:varchar(255);not null;" json:"-"`
	...
	Format       string `gorm:"type:varchar(20);check:format IN ('spdx-json','cyclonedx-json','syft-json');default:'spdx-json';comment:文件格式" json:"-"`
