...
func init() {
	...
	var explicitIgnores = []ignoreValues{
		// Based on https://DIDTrustCore/util/grype/issues/552, which includes a reference to the
		...
		// Based on https://DIDTrustCore/util/grype/issues/558:
		{
			typ:             "go-module",
		...
		// https://DIDTrustCore/util/grype/issues/2412#issuecomment-2663656195
		{
			typ:             "deb",
