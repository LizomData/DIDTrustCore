...
import (
	...
	"DIDTrustCore/util/grype/grype/search"
...
func TestMatchByImage(t *testing.T) {
	...
	tests := []struct {
		...
		// TODO: add this back in when #744 is fully implemented (see https://DIDTrustCore/util/grype/issues/744#issuecomment-2448163737)
		//{
