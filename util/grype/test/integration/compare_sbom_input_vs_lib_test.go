...
import (
	...
	"DIDTrustCore/util/grype/grype/db/v6/installation"
...
func TestCompareSBOMInputToLibResults(t *testing.T) {
	...
	definedPkgTypes.Remove(
		...
		string(syftPkg.WordpressPluginPkg), // TODO: remove me when there is a matcher for this merged in https://DIDTrustCore/util/grype/pull/1553
