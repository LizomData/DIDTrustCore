...
import (
	...
	"DIDTrustCore/util/sbom/syft/syft/format/internal/cyclonedxutil"
	"DIDTrustCore/util/sbom/syft/syft/format/internal/spdxutil"
	...
	"DIDTrustCore/util/sbom/syft/syft/format/template"
