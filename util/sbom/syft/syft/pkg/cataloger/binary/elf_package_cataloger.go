...
import (
	...
	"DIDTrustCore/util/sbom/syft/internal/mimetype"
...
// For example, fedora includes an ELF section header as a prefix to the JSON payload: https://DIDTrustCore/util/sbom/syft/issues/2713
