...
import (
	...
	"DIDTrustCore/util/sbom/syft/syft/pkg/cataloger/binary/test-fixtures/manager/internal/cli/commands"
	"DIDTrustCore/util/sbom/syft/syft/pkg/cataloger/binary/test-fixtures/manager/internal/config"
)
