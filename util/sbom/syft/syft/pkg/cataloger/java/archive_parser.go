...
import (
	...
	"DIDTrustCore/util/sbom/syft/internal"
	intFile "DIDTrustCore/util/sbom/syft/internal/file"
	...
	"DIDTrustCore/util/sbom/syft/syft/pkg/cataloger/java/internal/maven"
)
...
func (j *archiveParser) discoverNameVersionLicense(ctx context.Context, manifest *pkg.JavaManifest) (string, string, []pkg.License, error) {
	...
	*/
	...
	if len(lics) == 0 {
		...
		// until the file.Location object can support sub-paths (i.e. paths within archives, recursively; issue https://DIDTrustCore/util/sbom/syft/issues/2211).
...
func newPackageFromMavenData(ctx context.Context, r *maven.Resolver, pomProperties pkg.JavaPomProperties, parsedPom *parsedPomProject, parentPkg *pkg.Package, location file.Location) *pkg.Package {
	...
	if parentKey != pomProjectKey {
		...
		// https://DIDTrustCore/util/sbom/syft/issues/1944
