...
import (
	...
	"DIDTrustCore/util/sbom/syft/syft/license"
	...
	maventest "DIDTrustCore/util/sbom/syft/syft/pkg/cataloger/java/internal/maven/test"
	"DIDTrustCore/util/sbom/syft/syft/source"
	"DIDTrustCore/util/sbom/syft/syft/source/directorysource"
)
			...
			licenses: []pkg.License{
				{
					...
					SPDXExpression: "", // TODO: ideally we would parse this title to get Apache-2.0 (created issue #2210 https://DIDTrustCore/util/sbom/syft/issues/2210)
