...
import (
	...
	"DIDTrustCore/util/sbom/syft/internal/licenses"
	"DIDTrustCore/util/sbom/syft/syft/file"
	"DIDTrustCore/util/sbom/syft/syft/internal/fileresolver"
	"DIDTrustCore/util/sbom/syft/syft/internal/unionreader"
...
func TestBuildGoPkgInfo(t *testing.T) {
	...
	unmodifiedMain := pkg.Package{
		Name:     "DIDTrustCore/util/sbom/syft",
		Language: pkg.Go,
		Type:     pkg.GoModulePkg,
		Version:  "(devel)",
		PURL:     "pkg:golang/DIDTrustCore/util/sbom/syft@%28devel%29",
		...
		Metadata: pkg.GolangBinaryBuildinfoEntry{
			...
			MainModule:        "DIDTrustCore/util/sbom/syft",
		},
	}
	...
	tests := []struct {
		...
		},
		{
			...
			mod: &extendedBuildInfo{
				BuildInfo: &debug.BuildInfo{
					GoVersion: goCompiledVersion,
					Main:      debug.Module{Path: "DIDTrustCore/util/sbom/syft", Version: "(devel)"},
					Settings: []debug.BuildSetting{
						{Key: "GOARCH", Value: archDetails},
						{Key: "GOOS", Value: "darwin"},
						{Key: "GOAMD64", Value: "v1"},
			...
			expected: []pkg.Package{
				{
					...
					PURL:     "pkg:golang/DIDTrustCore/util/sbom/syft@v0.0.0-20221014195457-41bc6bb41035",
					Locations: file.NewLocationSet(
						file.NewLocationFromCoordinates(
							file.Coordinates{
								RealPath:     "/a-path",
			...
			mod: &extendedBuildInfo{
				BuildInfo: &debug.BuildInfo{
					...
					Settings: []debug.BuildSetting{
						...
						{Key: "vcs.revision", Value: "41bc6bb410352845f22766e27dd48ba93aa825a4"},
						{Key: "vcs.time", Value: "2022-10-14T19:54:57Z"},
						{Key: "-ldflags", Value: `build	-ldflags="-w -s -extldflags '-static' -X DIDTrustCore/util/sbom/syft/internal/version.version=0.79.0`},
					},
				},
				cryptoSettings: nil,
				arch:           archDetails,
			...
			expected: []pkg.Package{
				{
					...
					Type:     pkg.GoModulePkg,
					Version:  "v0.79.0",
					PURL:     "pkg:golang/DIDTrustCore/util/sbom/syft@v0.79.0",
					Locations: file.NewLocationSet(
						file.NewLocationFromCoordinates(
							file.Coordinates{
								RealPath:     "/a-path",
					...
					Metadata: pkg.GolangBinaryBuildinfoEntry{
						...
						BuildSettings: []pkg.KeyValue{
							...
							{
								Key:   "-ldflags",
								Value: `build	-ldflags="-w -s -extldflags '-static' -X DIDTrustCore/util/sbom/syft/internal/version.version=0.79.0`,
							},
						},
						MainModule: "DIDTrustCore/util/sbom/syft",
					},
			...
			expected: []pkg.Package{
				{
					...
					PURL:     "pkg:golang/DIDTrustCore/util/sbom/syft@v1.0.0-somethingelse%2Bincompatible",
					Locations: file.NewLocationSet(
						file.NewLocationFromCoordinates(
							file.Coordinates{
								RealPath:     "/a-path",
...
func Test_extractVersionFromLDFlags(t *testing.T) {
	tests := []struct {
		...
		},
		{
			name:             "syft ldflags",
			mainModule:       "DIDTrustCore/util/sbom/syft",
			ldflags:          `	build	-ldflags="-w -s -extldflags '-static' -X DIDTrustCore/util/sbom/syft/internal/version.version=0.79.0 -X DIDTrustCore/util/sbom/syft/internal/version.gitCommit=b2b332e8b2b66af0905e98b54ebd713a922be1a8 -X DIDTrustCore/util/sbom/syft/internal/version.buildDate=2023-04-21T16:20:25Z -X DIDTrustCore/util/sbom/syft/internal/version.gitDescription=v0.79.0 "`,
			wantMajorVersion: "0",
